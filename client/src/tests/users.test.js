...
/*describe("UsersPage", () => {
    describe("Valid inputs", () => {
        it('calls the onSubmit function', async () => {
            ...
            const { getByLabelText, getByRole } = render( < UserContext.Provider value = { providerTestUser } >< ShoppingCartContext.Provider value = { providerTestCart } >< AppRouter > < UsersPage onSubmit = { mockOnSubmit }
